...
if __name__ == '__main__':
    config_path = './output/Fault_Baseline/swin_unetr_base_supbaseline_p16_v01/config.yaml'
    ckpt_path = './output/Fault_Baseline/swin_unetr_base_supbaseline_p16_v01/checkpoints/best.ckpt'
    output_path = './output/Fault_Baseline/swin_unetr_base_supbaseline_p16_v01/preds'
