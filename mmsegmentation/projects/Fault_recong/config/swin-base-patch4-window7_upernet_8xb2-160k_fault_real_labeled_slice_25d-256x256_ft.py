...
data_root = '/home/zhangzr/Fault_Recong/Fault_data/real_labeled_data/2d_slices'
crop_size = (256, 256)
train_pipeline = [
    dict(type='LoadImageFromNpy', convert_25d=True, step=5, max_slice_id=372),
...
test_pipeline = [
    dict(type='LoadImageFromNpy', convert_25d=True, step=5, max_slice_id=127),
    # dict(type='Resize', scale=(512, 512), keep_ratio=True),
    dict(type='LoadAnnotations'),
    dict(type='PackSegInputs')
]
...
log_level = 'INFO'
load_from = './output/swin-base-patch4-window7_upernet_8xb2-160k_fault_real_labeled_slice_25d-256x256-dilate_ft_1/Best_Dice_33.pth'
resume = False
