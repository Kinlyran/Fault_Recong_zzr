...
data_preprocessor = dict(
    ...
    mean=[0.7663031255904045, 0.7663031255904045, 0.7663031255904045],
    std=[6577.816132024975, 6577.816132024975, 6577.816132024975],
    bgr_to_rgb=False,
    pad_val=0,
    seg_pad_val=0,
    size=(256, 256))
...
model = dict(
    ...
    backbone=dict(
        ...
        init_cfg=dict(type='Pretrained',checkpoint='/home/zhangzr/Fault_Recong/mmpretrain/output/simmim_swin-base-w7_3000e_256x256_0519_2d_fault/epoch_3000.pth')
        ),
    decode_head=dict(
        type='UPerHead',
...
data_root = '/home/zhangzr/Fault_Recong/Fault_data/2Dfault_0519_256/converted_slice_split'
crop_size = (256, 256)
train_pipeline = [
